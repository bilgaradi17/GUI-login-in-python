...
# Function to design the registration window
def register():
...
# Function to design the login window
def login():
    global login_screen
    ...
    # Define global variables for verifying username and password
...
# Function to display invalid password message
...
# Functions to delete popup screens
